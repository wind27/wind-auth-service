...
DEPLOY_DIR=`pwd`
#配置文件目录
CONF_DIR=$DEPLOY_DIR/conf:$DEPLOY_DIR/conf/spring:$DEPLOY_DIR/META-INF/
#jar包目录
...
nohup java -Ddev=DEV -Ddev_meta=http://apollo:8080 -classpath $CONF_DIR:$LIB_JARS com.wind.auth.Application
